...
## 如何使用
  ...
  **选择简体中文语言包（zh_CN）**  
  ...
  - 然后去页面最底部，找到 `Localization (requires restart)` 小项，找到在下拉选单中选中 `简体中文语言包_SrormyOrange` （如果没有就按一下🔄按钮），如图  
...
<details>
  ...
  **选择简体中文语言包（zh_CN）**  
  - 在 `Settings` 选项卡中，找到 `Localization (requires restart)` 小项，然后在下拉选单中选中 `简体中文语言包_SrormyOrange` （如果没有就按一下🔄按钮），如图  
